...
def index():
    ...
    # send the posts to the index.html temp to be disaplayed.
...
def create():
    # determine if page is being reqiested with a get or post request
...
def edit(id):
    ...
    if request.method=='POST':
        #get the title & contenr
        title = request.form['title']
        content = request.form['content']

        # if not title or content, flash an error msg
...
# create a route to delete a post from the edit page
# post id is the url parameter
